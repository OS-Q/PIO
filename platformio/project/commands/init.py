...
|  |     |- Bar.c
|  |     |- Bar.h
|  |  |- library.json (optional, custom build options, etc) https://doc.os-q.com/pio/page/librarymanager/config.html
|  |
|  |--Foo
|  |  |- Foo.c
|  |  |- Foo.h
...
- https://doc.os-q.com/pio/page/librarymanager/ldf.html
""",
        )
...
- https://doc.os-q.com/pio/advanced/unit-testing/index.html
""",
        )
